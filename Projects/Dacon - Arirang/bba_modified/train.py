...
class TrainModule(object):
    ...
    def train_network(self, args):
        ...
        if args.train_from != 'None':
            self.model, self.optimizer, start_epoch = self.load_model(self.model, self.optimizer, os.path.join(save_path, args.resume))
    ...
    def run_epoch(self, phase, data_loader, criterion):
        ...
        eeee = time.time() - start_time
        print(f'{phase} loss: {epoch_loss} , elapsed time : {eeee}')
        return epoch_loss
